...
public class IntakeIOSim implements IntakeIO {
    private final DCMotorSim simWheels =
            new DCMotorSim(
                    DCMotor.getNeo550(1), Constants.IntakeConstants.WHEELS_GEARING, Constants.IntakeConstants.MOI);
    private final DCMotorSim simRollers =
            new DCMotorSim(
                    DCMotor.getNeo550(1), Constants.IntakeConstants.ROLLER_GEARING, Constants.IntakeConstants.MOI);
