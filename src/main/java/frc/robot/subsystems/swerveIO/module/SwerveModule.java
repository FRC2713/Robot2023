...
public class SwerveModule extends SubsystemBase {
  ...
  public void update() {
    ...
    boolean useMotorEncoder = Math.abs(inputs.aziAbsoluteEncoderAdjAngleDeg) < 0.1 || Robot.isSimulation();
    boolean useAbsoluteEncoder = Math.abs(inputs.aziEncoderPositionDeg) < 0.1;
    double feedbackVal;
    if (useMotorEncoder) {
