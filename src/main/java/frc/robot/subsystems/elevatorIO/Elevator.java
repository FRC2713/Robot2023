  ...
  public static class Commands {
    ...
    public static Command setToHeightAndWait(double targetHeightInches) {
      if (targetHeightInches
        ...
        Logger.getInstance()
            .recordOutput("Field Piece Manipulation/Scoring/Intake set Point", "Low Cone Score");
      } else if (targetHeightInches
          == Constants.SuperstructureConstants.SCORE_CONE_MID.getElevatorPosition()) {
        Logger.getInstance()
            .recordOutput("Field Piece Manipulation/Scoring/Intake set Point", "Mid Cone Score");
      } else if (targetHeightInches
          == Constants.SuperstructureConstants.SCORE_CONE_HIGH.getElevatorPosition()) {
        Logger.getInstance()
            .recordOutput("Field Piece Manipulation/Scoring/Intake set Point", "High Cone Score");
      } else if (targetHeightInches
          == Constants.SuperstructureConstants.SCORE_CUBE_LOW.getElevatorPosition()) {
        Logger.getInstance()
            .recordOutput("Field Piece Manipulation/Scoring/Intake set Point", "Low Cube Score");
      } else if (targetHeightInches
          == Constants.SuperstructureConstants.SCORE_CUBE_MID.getElevatorPosition()) {
        Logger.getInstance()
            .recordOutput("Field Piece Manipulation/Scoring/Intake set Point", "Mid Cube Score");
      } else if (targetHeightInches
          == Constants.SuperstructureConstants.SCORE_CUBE_HIGH.getElevatorPosition()) {
        Logger.getInstance()
            .recordOutput("Field Piece Manipulation/Scoring/Intake set Point", "High Cube Score");
      } else if (targetHeightInches
          == Constants.SuperstructureConstants.INTAKE_UPRIGHT_CONE.getElevatorPosition()) {
        Logger.getInstance()
            .recordOutput(
                "Field Piece Manipulation/Scoring/Intake set Point", "Intake Upright Cone");
      } else if (targetHeightInches
          == Constants.SuperstructureConstants.INTAKE_TIPPED_CONE.getElevatorPosition()) {
        Logger.getInstance()
            .recordOutput(
                "Field Piece Manipulation/Scoring/Intake set Point", "Intake Tipped Cone");
      } else if (targetHeightInches
          == Constants.SuperstructureConstants.INTAKE_CUBE.getElevatorPosition()) {
        Logger.getInstance()
            .recordOutput("Field Piece Manipulation/Scoring/Intake set Point", "Intake Cube");
      }
