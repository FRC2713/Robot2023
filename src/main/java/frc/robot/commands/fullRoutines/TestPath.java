...
public class TestPath extends SequentialCommandGroup {
  ...
  // Shooter config
  // private Command shootuntillempty(SuperstructureConfig config) {
  ...
  public TestPath() {
    addCommands(
        new InstantCommand(
            () -> {
              Robot.swerveDrive.resetOdometry(
                  Autos.TestStringB.getTrajectory().getInitialHolonomicPose());
        ...
        // Execute Path
        SwerveSubsystem.Commands.stringTrajectoriesTogether(Autos.TestStringB.getTrajectory()),
        // Shoot Command
        // shootuntillempty(high)
        SwerveSubsystem.Commands.stringTrajectoriesTogether(Autos.TestStringA.getTrajectory()));
  }
}
